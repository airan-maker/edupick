    ...
    () =>
      requestedRole === "INSTRUCTOR"
        ? {
            badge: "강사 전용",
            title: "강사 전용 로그인",
            description: "학원, 반, 공지, 수납 화면은 강사 계정으로 로그인하면 바로 이어집니다.",
            helper: "강사 계정으로 로그인하면 하단 네비가 스튜디오 기준으로 전환됩니다.",
          }
        : {
            badge: "학부모 메인",
            title: "에듀픽 로그인",
            description: "주변 학원 비교부터 신청, 일정, 결제까지 학부모 흐름으로 이어집니다.",
            helper: "학부모 계정은 탐색과 일정 중심 화면으로 바로 연결됩니다.",
          },
    [requestedRole]
  );
